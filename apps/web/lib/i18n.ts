...
const ptBR = {
  ...
  'dashboard.stats_empty': 'Nada por aqui neste período',
  'dashboard.stats_empty_hint': 'Ouça algumas faixas ou tente outro período.',
...
const enUS: Record<WebMessageKey, string> = {
  ...
  'dashboard.stats_empty': 'Nothing here for this period',
  'dashboard.stats_empty_hint': 'Listen to some tracks or try another period.',
...
const jaJP: Record<WebMessageKey, string> = {
  ...
  'dashboard.stats_empty': 'この期間のデータはありません',
  'dashboard.stats_empty_hint': '何か聴くか、別の期間を試してください。',
...
const esES: Record<WebMessageKey, string> = {
  ...
  'dashboard.estimated_badge': '≈ estimado',
  'dashboard.stats_empty': 'Nada por aquí en este período',
  'dashboard.stats_empty_hint': 'Escucha algunas pistas o prueba otro período.',
